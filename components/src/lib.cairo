// The following example shows a simple Switchable component that
//  can be used to add a switch that can be either on or off. 
//It contains a storage variable switchable_value, 
//a function switch and an event Switch.
